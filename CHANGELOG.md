...
- 보정: 순서 정정(주사위@#5, 연두장판@#6, 유도@#8+6s), 알테마 블래스터를 **빨간 직선 → 연보라 꺽쇠 투사체가 중앙 관통 이동**으로, 보스를 **웨이마크 위(13m)** 로 배치(스토어 boss 좌표/반지름), 넉백 0.3초, **공략보기 선택 대상이 중앙 고정되던 버그 수정**(self id 미설정).
